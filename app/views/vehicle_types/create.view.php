        ...
        <div id="main-content" class="pt-0">
            <div class="page-heading">
                <div class="page-title">
                    <div class="row">
                        <div class="col-12 col-md-6 order-md-1 order-last">
                            ...
                            <p class="text-subtitle text-muted">Add a new vehicle type</p>
                        </div>
                ...
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="<?= url('vehicle-types') ?>" class="form form-vertical">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label for="vt_name" class="form-label">Name</label>
                                                <input type="text" name="vt_name" class="form-control"
                                                       placeholder="Enter vehicle type">
                                            </div>
                                            <div class="form-group">
                                                <label for="km_rate" class="form-label">Rate / Km</label>
                                                <input type="number" name="km_rate" class="form-control"
